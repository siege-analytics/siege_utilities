...
CANONICAL_GEOGRAPHIC_LEVELS: Dict[str, dict] = {
    ...
    "cousub":      {"aliases": ["county_subdivision", "county subdivision"],      "geoid_length": 10},
    "place":       {"aliases": [],                                               "geoid_length": 7},
    "cd":          {"aliases": ["congressional_district",
                                "congressional district"],                      "geoid_length": 4},
    "sldu":        {"aliases": ["state_legislative_upper",
                                "state_legislative_district_upper",
                                "state_legislative_district",
                                "state legislative upper",
                                "state legislative district upper",
                                "state legislative district"],                   "geoid_length": 5},
    "sldl":        {"aliases": ["state_legislative_lower",
                                "state_legislative_district_lower",
                                "state legislative lower",
                                "state legislative district lower"],             "geoid_length": 5},
    "tract":       {"aliases": [],                                               "geoid_length": 11},
    "block_group": {"aliases": ["bg", "blockgroup", "block group"],              "geoid_length": 12},
